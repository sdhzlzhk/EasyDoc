...
//        XWPFHeader hdr = doc.createHeaderFooterPolicy().getDefaultHeader();
...
//        XWPFFooter ftr = doc.createHeaderFooterPolicy().getDefaultFooter();
        XWPFFooter ftr = doc.createHeaderFooterPolicy().createFooter(XWPFHeaderFooterPolicy.DEFAULT);
